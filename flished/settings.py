...
CSP_IMG_SRC = [
    ...
    "https://*.bootstrapcdn.com", "https://*.fontawesome.com", "https://twemoji.maxcdn.com", 
    "https://images.unsplash.com", "https://*.gstatic.com"
]
CSP_STYLE_SRC = [
...
CSP_FONT_SRC = [
    "'self'", "https://*.googleadservices.com", "https://*.google.de", "https://*.google.com", "https://*.google.fr", 
    "https://*.g.doubleclick.net", "https://*.googlesyndication.com", "*.flished.com", "*.googletagmanager.com", 
    "*.google-analytics.com", "*.bootstrapcdn.com", "*.fontawesome.com", "*.gstatic.com"
]
CSP_FRAME_ANCESTORS = [
    "'self'", "https://*.googleadservices.com", "https://*.google.de", "https://*.google.com", 
    "https://*.google.fr", "https://*.g.doubleclick.net", "https://*.googlesyndication.com",
    "https://*.lyshoping.com", "https://*.flished.com", "https://*.lipa-betaal.com", "https://*.googletagmanager.com", 
