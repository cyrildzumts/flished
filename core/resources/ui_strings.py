...
UI_HISTORY_LABEL = _("History")
UI_SIGN_UP_LABEL = _("Sign Up")
UI_SIGN_IN_LABEL = _("Sign In")
UI_LOGIN_LABEL = _("Login")
UI_LOGOUT_LABEL = _("Logout")
UI_LOGIN_FORGOT_PW = _("Forgot your password ?")
UI_LOGIN_NO_ACCOUNT = _("You do not have an account ?")
UI_SIGN_UP_HAVE_ACCOUNT = _("Already have an account ?")
UI_LOGIN_CREATE_LABEL = _("Create my Account")
UI_DASHBOARD_LABEL = _("Dashboard")
UI_USER_HISTORY_LABEL = _("My Read history")
UI_MY_RECENT_POSTS_LABEL = _("My Recent Publications")
UI_MY_POSTS_LABEL = _("My Publications")
UI_SCHEDULED_POSTS_LABEL = _("Scheduled Publications")
UI_SCHEDULED_LABEL = _("Scheduled")
UI_USER_NO_HISTORY = _("You have not read a story yet.")
UI_USER_ACCOUNT = _("My Account")
...
UI_COOKIE_PREFERENCES = _('Preferences')
UI_COOKIE_ENABLE_ALL = _('Enable all')
UI_COOKIE_ENABLE = _('Enable')
UI_BACK_BTN_LABEL = _('Back')
UI_OK_BTN_LABEL = _("OK")
UI_REFUSE_BTN_LABEL = _("Refuse")
...
UI_DELETE_SELECTION_BTN_LABEL = _("Delete seleted")
...
UI_POST_SCHEDULE_LABEL = _("Schedule your publication")
UI_POST_SCHEDULE_HINT = _("Select the date at which you want your post to be published. Leave it empty it if you want your publication to be published as soon as possible. It is recommended to use an interval of 30 minutes.")
...
UI_RESOURCE_NOT_FOUND = _('The resource you requested does not exist or is no longer available. Visit our blog to discover other blog posts.')
...
UI_STRINGS_CONTEXT = {
    'UI_DELETE_SELECTION_BTN_LABEL': UI_DELETE_SELECTION_BTN_LABEL,
    'UI_LOGIN_FORGOT_PW': UI_LOGIN_FORGOT_PW,
    'UI_LOGIN_NO_ACCOUNT': UI_LOGIN_NO_ACCOUNT,
    'UI_SIGN_UP_HAVE_ACCOUNT': UI_SIGN_UP_HAVE_ACCOUNT,
    'UI_LOGIN_CREATE_LABEL': UI_LOGIN_CREATE_LABEL,
    'UI_SIGN_UP_LABEL': UI_SIGN_UP_LABEL,
    'UI_SIGN_IN_LABEL': UI_SIGN_IN_LABEL,
    'UI_LOGIN_LABEL': UI_LOGIN_LABEL,
    'UI_LOGOUT_LABEL': UI_LOGOUT_LABEL,
    'UI_DASHBOARD_LABEL': UI_DASHBOARD_LABEL,
    'UI_HISTORY_LABEL': UI_HISTORY_LABEL,
    'UI_MY_RECENT_POSTS_LABEL': UI_MY_RECENT_POSTS_LABEL,
    'UI_MY_POSTS_LABEL': UI_MY_POSTS_LABEL,
    'UI_USER_ACCOUNT': UI_USER_ACCOUNT,
    'UI_SCHEDULED_LABEL': UI_SCHEDULED_LABEL,
    'UI_SCHEDULED_POSTS_LABEL': UI_SCHEDULED_POSTS_LABEL,
    'UI_POST_SCHEDULE_LABEL': UI_POST_SCHEDULE_LABEL,
    ...
    'UI_REFUSE_BTN_LABEL': UI_REFUSE_BTN_LABEL,
